...
public class ApiTests {
    ...
    @Test(mainClass = DumpCollapsed.class, jvmArgs = "-Djava.library.path=build", output = true)
    ...
    @Test(mainClass = StopResume.class, jvmArgs = "-Djava.library.path=build", output = true)
